...
type SpinnerProps = VariantProps<typeof spinnerClasses> & {
  className?: string;
};
...
const spinnerClasses = cva("inline animate-spin", {
  variants: {
    variant: {
      primary: "text-gray fill-white",
...
const Spinner = (props: SpinnerProps) => {
  ...
  return (
    <div role="status">
      <svg
        aria-hidden="true"
        className={cn(spinnerClasses({ variant, size }), className)}
        viewBox="0 0 100 101"
        fill="none"
